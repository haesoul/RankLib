    ...
    if (isVideo(item)) {
      return (
          <View style={styles.fullscreenContainer}>
            <VideoPlayer uri={item.uri} poster={item.thumbnailUri} isActive={active} />
            ...
            <>
              ...
              <Button onPress={() => 
                setDeleteMediaModal(true)
                  ...
                  style={{ width: 50, marginLeft: 8, paddingHorizontal: 0 }}>
        ...
        <RNModal 
          ...
          <View style={styles.modalSafe}>
            <View style={styles.modalHeader}>
              <TouchableOpacity onPress={() => setSelectedIndex(null)} style={styles.headerBtn}>
                <MaterialIcons name="close" size={28} color="#fff" />
              </TouchableOpacity>
              <Text style={styles.modalTitle}>{obj?.name ?? ''}</Text>
              <View style={{ width: 40 }} />
            </View>
...
const styles = StyleSheet.create({
  ...
  modalHeader: { height: 0, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 12 },
  modalTitle: { flex: 1, textAlign: 'center', color: '#fff', fontSize: 16, fontWeight: '600' },
  fullscreenContainer: { width, height: height, alignItems: 'center', justifyContent: 'center', top: 0, left: 0 },
  fullscreenMedia: { width: width, height: height, left: 0 },
  caption: { color: '#fff', marginTop: 12, paddingHorizontal: 20, textAlign: 'center' },
